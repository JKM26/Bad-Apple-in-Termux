...
pip install pillow
Do this by simply typing them into the Terminal
...
Thats done by typing in this vommand line
ffmpeg -i Badapple.mp4 -q:a 0 -map a Badapple.mp3
Then you have the mp4 split into frames and the mp3
...
If you want to stop it just tsp Ctrl+C it stops both codes instantly and thats it
